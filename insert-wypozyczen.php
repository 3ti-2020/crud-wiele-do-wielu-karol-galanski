<?php
    ...
    // $sql = "INSERT INTO `wypozyczenia`(`id_wypo`, `id_book`, `id_user`, `data_wypozyczenia`, `data_oddania`) VALUES (NULL, '".$_POST['wybrana-ksiazka']."', '".$_POST['wybrany-uzytkownik']."', '".$_POST['data-wyp']."', NULL)";
